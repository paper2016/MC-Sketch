...
We also implement a series of **slim-fat sketches** (i.e. the SF1, SF2, SF3, SF4 and SF5 sketches) that lead to our final ***MC sketch***. Using `sh build.sh SF1` for our first version of slim-fat sketch (**the SF1 sketch**).
